...
import static mjt.shopwise.SQLitePragmaConstants.*;
...
public class CommonSQLiteUtilities {
    ...
    static final String SM_TABLE_NAME_COLUMN = "tbl_name";
    ...
    static final String SM_TYPE_TRIGGER = "trigger";
    ...
    public static void logDatabaseInfo(SQLiteDatabase db) {
        ...
        */
        ...
        while (tlcsr.moveToNext()) {
            String current_table = tlcsr.getString(tlcsr.getColumnIndex(SM_TABLE_NAME_COLUMN));
            Log.d(CSU_TAG,
        ...
        */
        ...
        while (csr.moveToNext()) {
            ...
            for (int i=0; i < columncount;i++) {
                ...
                sb.append(strval_log);
                sb.append(lngval_log);
                sb.append(dblval_log);
                sb.append(blbval_log);
    ...
    /**
     * Write out Foreign Key information to the Log
     * @param db        The SQliteDatabase
    ...
    private static void logTriggers(SQLiteDatabase db, String table) {
        StringBuilder sb = new StringBuilder();
        String sqlstr = "SELECT * FROM " + SQLITE_MASTER +
                " WHERE " + SM_TABLE_TYPE_COLUMN + " = '"  + SM_TYPE_TRIGGER + "'" +
                " AND " + SM_TABLE_NAME_COLUMN + "=?";
        ...
        while (csr.moveToNext()) {
            ...
            sb.append("\n\tSQL = ");
            sb.append(csr.getString(csr.getColumnIndex(SM_SQL_COLUMN)));
        }
        Log.d(CSU_TAG,sb.toString());
        csr.close();
    }
