...
public class SQLKWORD {
    ...
    public static final String SQLINSERT = " INSERT ";
    public static final String SQLDELETE = " DELETE ";
    public static final String SQLBEFORE = " BEFORE ";
    public static final String SQLAFTER = " AFTER ";
    public static final String SQLINSTEADOF = " INSTEAD OF ";
    public static final String SQLUPDATEOF = " UPDATE OF ";
    public static final String SQLFOREACHROW = " FOR EACH ROW ";
    public static final String SQLTRIGGER = " TRIGGER ";
    public static final String SQLDROP = " DROP ";
    public static final String SQLBEGIN = " BEGIN ";
    public static final String SQLTHEN = " THEN ";
    public static final String SQLEND = " END ";
    ...
    public static final String SQLWHEN = " WHEN ";
